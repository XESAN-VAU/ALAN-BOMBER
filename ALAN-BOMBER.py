...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : ALAN BABY 007.                \033[94m│".center(columns+15))
    ...
    print("│ \033[95mCoder  : XESAN AHMED              \033[37mV1.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mALAN-BOMBER\n")
        time.sleep(0.6)
